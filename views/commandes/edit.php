    ...
    <div class="container-fluid">
        <div class="card card-warning">
            <div class="card-header">
                <h3 class="card-title">Modification de la commande <?php echo $commande['reference']; ?></h3>
            </div>
            <form method="post" action="index.php?action=commandes/edit&id=<?php echo $commande['id']; ?>" id="editForm">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <!-- Informations client -->
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nom" name="nom" required
                                       value="<?php echo htmlspecialchars($commande['nom']); ?>">
                            </div>

                            <div class="form-group">
                                <label for="telephone">Téléphone</label>
                                <input type="tel" class="form-control" id="telephone" name="telephone"
                                       pattern="[0-9]{10}" value="<?php echo $commande['telephone']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="adresse" name="adresse" rows="3"
                                          ><?php echo htmlspecialchars($commande['adresse']); ?></textarea>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" id="montant" name="montant" 
                                           step="0.01" min="0" required value="<?php echo $commande['montant']; ?>">
        ...
        <?php echo OrderStatus::getStatusSelectOptions($commande['statut'] ?? OrderStatus::EN_ATTENTE); ?>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="notes" name="notes" rows="3"
                                          ><?php echo htmlspecialchars($commande['notes']); ?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
